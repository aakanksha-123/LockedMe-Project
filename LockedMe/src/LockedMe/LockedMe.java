...
public class LockedMe {
		...
		static final String projectpath="F:\\JavaProjects\\LockedMeFiles";
		...
		
		{
			...
			System.out.println("\tDeveloper Name: Aakanksha Kokane");
			System.out.println("***************************************************");
		...
		public static void getAllFiles()
		{
			...
			if(listofFiles.length>0) {
			      System.out.println("Files List display below:\n");
